...
public class UserEventMessage extends org.apache.avro.specific.SpecificRecordBase
  ...
  public static final org.apache.avro.Schema SCHEMA$ =
      new org.apache.avro.Schema.Parser()
          .parse(
              "{\"type\":\"record\",\"name\":\"UserEventMessage\",\"namespace\":\"com.ivanfranchin.userservice.messages\",\"fields\":[{\"name\":\"eventId\",\"type\":\"string\"},{\"name\":\"eventTimestamp\",\"type\":\"long\"},{\"name\":\"eventType\",\"type\":{\"type\":\"enum\",\"name\":\"EventType\",\"symbols\":[\"CREATED\",\"UPDATED\",\"DELETED\"]}},{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"userJson\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   *     this class
   */
  public static UserEventMessage fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
   ...
   */
  public UserEventMessage(
      java.lang.CharSequence eventId,
      java.lang.Long eventTimestamp,
      com.ivanfranchin.userservice.messages.EventType eventType,
      java.lang.Long userId,
      java.lang.CharSequence userJson) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      ...
      case 1:
        ...
        break;
      case 2:
        eventType = (com.ivanfranchin.userservice.messages.EventType) value$;
        break;
      case 3:
        userId = (java.lang.Long) value$;
        break;
      case 4:
        userJson = (java.lang.CharSequence) value$;
        break;
      default:
        throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
   ...
   */
  public static com.ivanfranchin.userservice.messages.UserEventMessage.Builder newBuilder(
      com.ivanfranchin.userservice.messages.UserEventMessage.Builder other) {
    if (other == null) {
      return new com.ivanfranchin.userservice.messages.UserEventMessage.Builder();
    } else {
   ...
   */
  public static com.ivanfranchin.userservice.messages.UserEventMessage.Builder newBuilder(
      com.ivanfranchin.userservice.messages.UserEventMessage other) {
    if (other == null) {
      return new com.ivanfranchin.userservice.messages.UserEventMessage.Builder();
    } else {
      return new com.ivanfranchin.userservice.messages.UserEventMessage.Builder(other);
  ...
  public static class Builder
      extends org.apache.avro.specific.SpecificRecordBuilderBase<UserEventMessage>
     ...
     * @return This builder.
     */
    public com.ivanfranchin.userservice.messages.UserEventMessage.Builder setEventId(
     ...
     * @return This builder.
     */
    public com.ivanfranchin.userservice.messages.UserEventMessage.Builder setEventTimestamp(
        long value) {
     ...
     * @return This builder.
     */
    public com.ivanfranchin.userservice.messages.UserEventMessage.Builder setEventType(
        com.ivanfranchin.userservice.messages.EventType value) {
     ...
     * @return This builder.
     */
    public com.ivanfranchin.userservice.messages.UserEventMessage.Builder setUserJson(
        java.lang.CharSequence value) {
    ...
    public UserEventMessage build() {
      try {
        ...
        record.eventId =
            fieldSetFlags()[0] ? this.eventId : (java.lang.CharSequence) defaultValue(fields()[0]);
        record.eventTimestamp =
            fieldSetFlags()[1] ? this.eventTimestamp : (java.lang.Long) defaultValue(fields()[1]);
        record.eventType =
            fieldSetFlags()[2]
                ? this.eventType
                : (com.ivanfranchin.userservice.messages.EventType) defaultValue(fields()[2]);
        record.userId =
            fieldSetFlags()[3] ? this.userId : (java.lang.Long) defaultValue(fields()[3]);
        record.userJson =
            fieldSetFlags()[4] ? this.userJson : (java.lang.CharSequence) defaultValue(fields()[4]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<UserEventMessage> WRITER$ =
      (org.apache.avro.io.DatumWriter<UserEventMessage>) MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<UserEventMessage> READER$ =
      (org.apache.avro.io.DatumReader<UserEventMessage>) MODEL$.createDatumReader(SCHEMA$);
    ...
    if (fieldOrder == null) {
      ...
      for (int i = 0; i < 5; i++) {
        switch (fieldOrder[i].pos()) {
          ...
          case 2:
            this.eventType =
                com.ivanfranchin.userservice.messages.EventType.values()[in.readEnum()];
            break;
          ...
          case 4:
            if (in.readIndex() != 1) {
              ...
              this.userJson =
                  in.readString(this.userJson instanceof Utf8 ? (Utf8) this.userJson : null);
            }
            break;
  ...
  public int hashCode() {
    ...
    result = 31 * result + (userJson == null ? 0 : userJson.hashCode());
    return result;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserEventMessage)) {
      return false;
    }
    ...
    if (this.eventTimestamp != other.eventTimestamp) {
      return false;
    }
    ...
    if (Utf8.compareSequences(this.userJson, other.userJson) != 0) {
      return false;
    }
    return true;
  }
