...
public abstract class AbstractTestcontainers {
  ...
  private static final GenericContainer<?> schemaRegistryContainer =
      new GenericContainer<>("confluentinc/cp-schema-registry:7.9.5");
  private static final GenericContainer<?> userServiceContainer =
      new GenericContainer<>("ivanfranchin/user-service:1.0.0");
  private static final GenericContainer<?> eventServiceContainer =
      new GenericContainer<>("ivanfranchin/event-service:1.0.0");
  ...
  private static void dynamicProperties(DynamicPropertyRegistry registry) {
    ...
    userServiceContainer
        ...
        .waitingFor(
            Wait.forHttp("/actuator/health")
                .forPort(USER_SERVICE_EXPOSED_PORT)
                .forStatusCode(200)
    ...
    USER_SERVICE_API_URL =
        String.format(
            ...
            userServiceContainer.getMappedPort(USER_SERVICE_EXPOSED_PORT));
